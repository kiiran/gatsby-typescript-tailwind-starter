...
export enum SitePageFieldsEnum {
  ...
  context___previousPostId = 'context___previousPostId',
...
export type PagesQueryQuery = {
  allSiteFunction: { nodes: Array<Pick<SiteFunction, 'apiRoute'>> }
...
export type BioQuery = {
  site?: Maybe<{
    siteMetadata?: Maybe<{ author?: Maybe<Pick<Author, 'name' | 'summary'>> }>
  }>
}
