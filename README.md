...
This starter is a clone of the [Gatsby blog starter](https://github.com/gatsbyjs/gatsby-starter-blog), but with TypeScript, GraphQL code-gen, Tailwind and eslint set up.
